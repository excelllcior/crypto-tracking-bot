...
@router.callback_query(inline.PaginationButtonCallback.filter(F.query == "change_candle_count"))
async def change_candle_count(callback_query: CallbackQuery, callback_data: inline.PaginationButtonCallback, state: FSMContext): 
