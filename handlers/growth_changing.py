...
@router.callback_query(inline.PaginationButtonCallback.filter(F.query == "change_growth_rate"))
async def change_growth_rate(callback_query: CallbackQuery, callback_data: inline.PaginationButtonCallback, state: FSMContext): 
