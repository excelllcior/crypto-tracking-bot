...
from .callback import ButtonCallback, PaginationButtonCallback
        ...
        [
            InlineKeyboardButton(
                ...
                callback_data=ButtonCallback(
                    query="back_to_main_kb", params=None
                ).pack(),
            )
        ]
    ]
            ...
            [
                InlineKeyboardButton(
                    ...
                    callback_data=PaginationButtonCallback(
                        query="change_params", params=str(pair["id"]), page=page
                    ).pack(),
                )
            ],
            [
                InlineKeyboardButton(
                    ...
                    callback_data=PaginationButtonCallback(
                        query="remove_pair", params=str(pair["id"]), page=page
                    ).pack(),
                )
            ],
            [
                InlineKeyboardButton(
                    text="« Назад",
                    callback_data=PaginationButtonCallback(
                        query="back_to_pairs", params=None, page=page
                    ).pack(),
                )
            ],
        ]
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="Да",
                    callback_data=ButtonCallback(
                        query="confirm_pair_removal", params=pair_id
                    ).pack(),
                ),
                InlineKeyboardButton(
                    text="Нет",
                    callback_data=PaginationButtonCallback(
                        query="back_to_pair", params=pair_id, page=page
                    ).pack(),
                ),
            ]
        ]
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="Процент роста",
                    callback_data=PaginationButtonCallback(
                        query="change_growth_rate", params=pair_id, page=page
                    ).pack(),
                )
            ],
            [
                InlineKeyboardButton(
                    ...
                    callback_data=PaginationButtonCallback(
                        query="change_correction_rate", params=pair_id, page=page
                    ).pack(),
                )
            ],
            [
                InlineKeyboardButton(
                    ...
                    callback_data=PaginationButtonCallback(
                        query="change_candle_count", params=pair_id, page=page
                    ).pack(),
                )
            ],
            [
                InlineKeyboardButton(
                    ...
                    callback_data=PaginationButtonCallback(
                        query="change_interval", params=pair_id, page=page
                    ).pack(),
                )
            ],
            [
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    ...
                    callback_data=PaginationButtonCallback(
                        query="back_to_pairs", params=None, page="1"
                    ).pack(),
                )
            ]
        ]
